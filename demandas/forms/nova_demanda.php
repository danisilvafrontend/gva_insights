...
// Admin pode selecionar qualquer responsável
$usuarios = [];
if ($isAdmin) {
  ...
  <div class="row">
    ...
    <div class="col-md-10 main-content py-4">
      ...
      <div class="card shadow-sm">
        <div class="card-header bg-primary text-white"><i class="bi bi-clipboard-plus me-2"></i>Cadastrar Nova Demanda / Tarefa</div>
        <div class="card-body">
          <form method="POST" action="processar_demanda.php" id="formDemanda">
            <div class="row g-3">
              ...
              <div class="col-md-12">
                ...
                <textarea name="detalhes" class="form-control" rows="2" placeholder="Informações adicionais..."></textarea>
              </div>
...
document.getElementById('selectCategoria').addEventListener('change', function () {
  ...
  document.querySelectorAll('.campo-conteudo').forEach(el => el.classList.toggle('d-none', !isC));
  document.querySelectorAll('.campo-link').forEach(el     => el.classList.toggle('d-none', !isC));
});
</script>
</body>
</html>
