        ...
        <!-- Cada relatório como card -->
            <div class="card shadow-sm mb-5" id="canais_parceiros">
                <div class="card-header bg-primary text-white text-center">
                    <h3><i class="bi bi-person-badge me-2"></i> Usuários GVA Company</h3>
                </div>
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-5">
                            <?php include '../forms/registro_usuario.php'; ?>
                        </div>
                    </div>

                    <div class="text-center mt-4">
                        <a href="../views_bd/views_usuarios.php" class="btn btn-outline-primary">Ver últimos Registros</a>
                    </div>
                </div>
            </div>
        </div>
